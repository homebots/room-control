<template>
  <div class="device-group" v-if="lights.length">
    <div class="header device-group__header">
      ...
      <button @click="store.allLightsOff()" class="device-group__all-off">
    ...
    <div class="device-group__body toggle-group">
      <button
        ...
        @click="store.toggleLight(device.id)"
        class="toggle"
